...
parser.add_argument('-gt', '--gt_path', type=str, default='data/MedSAMDemo_2D/train/labels',
...
parser.add_argument('--data_name', type=str, default='demo2d',
...
parser.add_argument('--checkpoint', type=str, default='/home/firmware/UsefulTemp/SAM/models/sam_vit_b_01ec64.pth', help='checkpoint')
...
for gt_name in tqdm(names):
    ...
    gt_data = transform.resize(gt_data == args.label_id, (args.image_size, args.image_size), order=0,
    ...
    if np.sum(gt_data) > 100:  # exclude tiny objects
        ...
        image_data_pre = transform.resize(image_data_pre, (args.image_size, args.image_size), order=3,
